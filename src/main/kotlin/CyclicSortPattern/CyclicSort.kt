...
fun main() {
println(cyclicSort(arrayOf(3, 1, 5, 4, 2)).contentToString())
println(cyclicSort(arrayOf(2, 6, 4, 3, 1, 5)).contentToString())
println(cyclicSort(arrayOf(1, 5, 6, 4, 3, 2)).contentToString())
}
